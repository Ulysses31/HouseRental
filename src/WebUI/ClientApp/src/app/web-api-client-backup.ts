        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<TodosViewModel>><any>_observableThrow(e);
                }
            } else
                return <Observable<TodosViewModel>><any>_observableThrow(response_);
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<TodosViewModel> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = TodosViewModel.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<TodosViewModel>(<any>null);
    }
...
export class WeatherForecastClient implements IWeatherForecastClient {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<WeatherForecastDto[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<WeatherForecastDto[]>><any>_observableThrow(response_);
        }));
    }
    ...
    protected processGet(response: HttpResponseBase): Observable<WeatherForecastDto[]> {
        ...
        return _observableOf<WeatherForecastDto[]>(<any>null);
    }
}
...
export class TodosViewModel implements ITodosViewModel {
    priorityLevels?: PriorityLevelDto[] | undefined;
    lists?: TodoListDto[] | undefined;

    constructor(data?: ITodosViewModel) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): TodosViewModel {
        data = typeof data === 'object' ? data : {};
        let result = new TodosViewModel();
        result.init(data);
        return result;
    }
...
export interface ITodosViewModel {
    priorityLevels?: PriorityLevelDto[] | undefined;
    lists?: TodoListDto[] | undefined;
}
